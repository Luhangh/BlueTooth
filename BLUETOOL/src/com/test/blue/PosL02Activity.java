...
public class PosL02Activity extends BaseActivity implements OnClickListener {
	...
	private Button btnSearch, btnStop;
	private ListView lvList;
	private TextView tvLockBluetooth, tvConnectName;
	private ArrayAdapter<String> adapter;
	private BluetoothAdapter bluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
	private List<BlueToothBean> devices = new ArrayList<BlueToothBean>();

	private String trmmodno, cardNo1;
	...
	private int count = 0, menoy = 200;
	private String ordernum, truedate, photonum, photoname, PinRandom, paypwd, MediaType;
	private String intentMsg, emvValue, FKFLG, pinkey, omfig, track, EncBatch, EncTrackRandom, icnumber, Trmmodno;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog2 = new ProgressDialog(PosL02Activity.this);
	...
	private void initView() {
		tvLockBluetooth = (TextView) findViewById(R.id.bluetooth_name);
		tvLockBluetooth.setText(name);
		tvConnectName = (TextView) findViewById(R.id.bluetooth_name_now);
		findViewById(R.id.back).setOnClickListener(this);
		tvTitle = (TextView) findViewById(R.id.title);
		tvMessage = (TextView) findViewById(R.id.pbbt_tv_msg);

		btnSearch = (Button) findViewById(R.id.btn_connect_bluetooth);
		...
		// lvList = (ListView) findViewById(R.id.device_lv);
		// lvList.setAdapter(adapter);
		lvList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Toast.makeText(PosL02Activity.this,"蓝牙名字"+name+"地址"+address, 1000).show();
				dialog.cancel();
			}
		});
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				BlueToothBean btContext = new BlueToothBean(
						device.getName() == null ? device.getAddress() : device.getName(), device.getAddress());
